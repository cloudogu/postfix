...
Es gibt mehrere Möglichkeiten, um Werte zu konfigurieren. 
Kurzgefasst kann man:

1. Das Postfix-Dogu mit `kubectl edit configmap -n ecosystem postfix-config` konfigurieren (empfohlen)
